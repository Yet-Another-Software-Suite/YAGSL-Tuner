...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem(File directory) {
    Pose2d startingPose = new Pose2d(10000.0, 10000.0, new Rotation2d(0.0));
  ...
  public Command rotateFromNTCommand() {
    return run(() -> Arrays.asList(swerveDrive.getModules())
        .forEach(it -> it.setAngle(SmartDashboard.getNumber("angle", 0.0))));
  }
  ...
  public Command driveStop() {
    return runOnce(() -> swerveDrive.drive(new Translation2d(0.0, 0.0), 0.0, false, false));
  }
